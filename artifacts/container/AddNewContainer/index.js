...
class AddNewPageContainer extends React.Component {
    constructor(props) {
        super(props);
        // console.log('>>>>')
    ...
    render() {
        ...
        console.log(params);
        return React.createElement(AddNew, { navigation: this.props.navigation, finished: (data, callback) => this.finished(data, callback), data: this.props.oldList, forward: params.value });
    }
}
